...
# fichero de backup, el update se encuentra actualizado en la V3
...
ls -C1 /var/spool/cron/* | while read job; do echo $job; echo;cat $job; echo; done
...
# Corregido por Angel Mora
service --status-all
# Añadido a sugerencia de Miguel Rojas (mrojas@canvia.com)
...
echo "---------------------------------- END LISTA DE SERVICIOS ACTIVOS -------------------------------"
echo ""
